...
/// нарисованы по-разному: анкета (`journey_screen.dart::_Wheel`) — с полосой
/// выбора, лестницей яркости и засечными цифрами; лист совместимости — плоским
...
/// которой натив отказался от колеса вовсе (довод целиком —
/// `journey_screen.dart::_Wheel`). Заодно первая строка — это половина
/// барабана, стоящая пустой: колонка из пяти строк показывала три. Владелец
/// снял оговорку 19.08.2026.
///
