...
class AlmaShrink {
  ...
  /// Стиль, которым строка **рисуется**, — для замера.
  ///
  /// `Text` не рисует переданным стилем: он сливает его со стилем по
  /// умолчанию (`DefaultTextStyle`), а его под `Material` задаёт тема —
  /// `bodyMedium`, у которого в Material 3 есть разрядка 0.25 точки на знак.
