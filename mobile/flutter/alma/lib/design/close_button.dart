    ...
    return Semantics(
      ...
      child: GestureDetector(
        ...
        onTap: () {
          ...
          // может зависнуть и остаться» (24 авг). Здесь это чинится один раз
          // для всех закрытий ПО КНОПКЕ; уходы мимо неё — автозакрытие после
          // входа (`sign_in_*`), смена вкладки (`main.dart`) — снимают фокус
          // сами, тем же приёмом.
