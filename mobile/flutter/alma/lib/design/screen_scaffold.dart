  ...
  Widget build(BuildContext context) {
    ...
    Widget list = ListView(
      ...
      padding: EdgeInsets.only(
        ...
        //
        // **Домашний индикатор считается отдельно, и без него правка была
        // неполной.** Бар рисует себя как `tabBarHeight` плюс
        // `MediaQuery.paddingOf(context).bottom` (`tab_bar.dart:81–83`), то
        // есть на этом айфоне занимает 52 + 34. Отступ же считал только 52, и
        // недостающие 34 съедали воздух целиком и прятали последнюю строку под
        // бар. Видно было там же, где и в прошлый раз: мелкий шрифт в
        // настройках — «For self-knowledge only…» обрывался на полуслове, и
        // страница дальше не листалась. На экранах покороче это не всплывало,
        // потому что список и так упирался в край.
        bottom: AlmaMetrics.tabBarHeight + MediaQuery.paddingOf(context).bottom + 26,
      ),
      children: [
