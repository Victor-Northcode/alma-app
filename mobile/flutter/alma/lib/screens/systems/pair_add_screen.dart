                      ...
                      child: IntrinsicHeight(
                        child: Column(
                          ...
                          children: [
                            ...
                            // Каретка стоит здесь по входу — так на кадре W2.
                            // Экран открывается ради одного ответа, «про
                            // кого», и первое поле у него не одно из четырёх,
                            // а то самое. Без этого человек, пришедший ввести
                            // человека, первым движением ищет, куда нажать.
                            CeremonialField(
                              controller: _name,
                              autofocus: true,
