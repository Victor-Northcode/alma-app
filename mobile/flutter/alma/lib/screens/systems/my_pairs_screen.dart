                  ...
                  for (final person in session.people)
                    _row(
                      ...
                      note: switch (byProfile[person.id]) {
                        // Подписчику нечего «читать первым бесплатно»: у него
                        // открыты все четыре главы к любому человеку, пока
                        // подписка жива. Строка про бесплатную первую главу
                        // стоит только тем, кому и правда открыта одна: она
                        // расходилась с вклейкой того же отчёта, где написано
                        // «four chapters», — два экрана про одно и то же
                        // говорили разное.
                        null when session.isSubscriber =>
                          '${l.pairRowChapters} · ${l.paywallV3PairIncludedBadge}',
                        null => l.pairRowFreeChapter,
