...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  /// из закрывшейся главы.
  ///
  /// Запрет W5 «не сокращать строку» снят владельцем 29.08.2026 («если
  /// однажды отменишь — покороче»): текст ужат до трёх коротких предложений
  /// на всех семи языках, все три факта на месте — купленное навсегда
  /// остаётся, подписочное закрывается, расчёт бесплатен. Разбивать на части
  /// по-прежнему нельзя.
