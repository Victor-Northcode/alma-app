...
///
/// **Контур — иконки приложения (`play-icon-512`), а не прямолинейный из
/// макета.** 24 августа владелец распорядился: «лого везде и в прилке самой
/// везде — как в play-icon-512». У иконки бока вогнутые (квадратичные дуги,
/// талия 0.14 короткой полуоси) и звезда выше, чем шире (W/H = 0.81); знак
/// сплэша, иконка на пружине телефона и системная заставка теперь один и тот
/// же силуэт. Прямолинейный контур холста снят этим распоряжением.
class _Mark extends CustomPainter {
  ...
  static final _path = Path()
    ..moveTo(23, 0)
    ..quadraticBezierTo(25.09, 19.78, 41.66, 23)
    ..quadraticBezierTo(25.09, 26.22, 23, 46)
    ..quadraticBezierTo(20.91, 26.22, 4.34, 23)
    ..quadraticBezierTo(20.91, 19.78, 23, 0)
    ..close();
