            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  PaywallPlate(
                    // **Своя вклейка, а не общий фон.** Здесь стояло `sky` —
                    // туманность, которая лежит под всеми экранами продукта, — с
                    // доводом «у живого слоя нет своей картинки». Довод был
                    // неверен: на холсте `V6` стоит `plate-sky`, отдельная
                    // вклейка. Владелец увидел и сказал: «тут не та картинка».
                    //
                    // Разница не в оттенке. Фон, показанный как предмет продажи,
                    // читается дырой в фоне, а не картиной: карточка теряет
                    // край, потому что за её рамкой ровно то же самое.
                    image: const AssetImage(AlmaArt.skyPlate),
                    height: 150,
