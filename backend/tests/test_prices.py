...
#: Полосы q5/q10/q25/year — лестница, выбранная по поручению владельца
#: 02.09.2026 («цены продумай все»): вход $1.99, штука дешевеет с
#: размером, q25 — компромисс-декой у подписки, год = 1.3 месяца.
#: Довод целиком — у товаров в catalogue.py; менять — только с ним разом.
GOLDEN: dict[str, dict[str, int]] = {
    "USD": {"door": 499, "pair": 499, "bundle": 1999, "monthly": 999, "q5": 199, "q10": 349, "q25": 699, "year": 1299},
