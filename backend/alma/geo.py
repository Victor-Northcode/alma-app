...
#: \u0421\u0442\u0440\u0430\u043D\u0430 \u2014 \u043D\u0430 \u044F\u0437\u044B\u043A\u0435 \u0447\u0438\u0442\u0430\u0442\u0435\u043B\u044F (\u0432\u043B\u0430\u0434\u0435\u043B\u0435\u0446, 25.08.2026: \u00AB\u043D\u0430 \u0440\u0443\u0441\u0441\u043A\u043E\u043C \u043C\u0435\u0441\u0442\u043E
#: \u0440\u043E\u0436\u0434\u0435\u043D\u0438\u044F \u043F\u043E-\u0440\u0443\u0441\u0441\u043A\u0438, \u0438 \u043D\u0430 \u043B\u044E\u0431\u043E\u043C \u0434\u0440\u0443\u0433\u043E\u043C \u044F\u0437\u044B\u043A\u0435 \u2014 \u043D\u0430 \u043D\u0451\u043C\u00BB). \u0418\u043C\u0435\u043D\u0430 \u043D\u0435\u0441\u0451\u0442 CLDR
#: \u0447\u0435\u0440\u0435\u0437 Babel (BSD \u2014 \u043B\u0438\u0446\u0435\u043D\u0437\u0438\u043E\u043D\u043D\u044B\u0439 \u0448\u043B\u044E\u0437 \u043F\u0440\u043E\u0445\u043E\u0434\u0438\u0442; pycountry \u043D\u0435 \u043F\u0440\u043E\u0448\u0451\u043B \u0431\u044B:
#: LGPL \u0441\u0442\u043E\u0438\u0442 \u0432 \u0437\u0430\u043F\u0440\u0435\u0442\u043D\u043E\u043C \u0441\u043F\u0438\u0441\u043A\u0435 tools/license_gate.py). \u041E\u0434\u043D\u0430 \u043F\u043E\u043F\u0440\u0430\u0432\u043A\u0430 \u043F\u043E\u0432\u0435\u0440\u0445
#: CLDR: \u0440\u0443\u0441\u0441\u043A\u043E\u0435 \u00AB\u0421\u043E\u0435\u0434\u0438\u043D\u0435\u043D\u043D\u044B\u0435 \u0428\u0442\u0430\u0442\u044B\u00BB \u0432 \u043F\u043E\u0434\u043F\u0438\u0441\u0438 \u043C\u0435\u0441\u0442\u0430 \u0447\u0438\u0442\u0430\u0435\u0442\u0441\u044F \u043A\u0430\u043D\u0446\u0435\u043B\u044F\u0440\u0438\u0435\u0439 \u2014
#: \u0436\u0438\u0432\u043E\u0439 \u044D\u043A\u0440\u0430\u043D \u043F\u0438\u0448\u0435\u0442 \u00AB\u0421\u0428\u0410\u00BB.
_COUNTRY_OVERRIDES: dict[tuple[str, str], str] = {
    ("US", "ru"): "\u0421\u0428\u0410",
}


@lru_cache(maxsize=16)
def _territories(lang: str) -> dict | None:
    """\u041A\u0430\u0440\u0442\u0430 \u043A\u043E\u0434\u2192\u0438\u043C\u044F \u043E\u0434\u043D\u043E\u0433\u043E \u044F\u0437\u044B\u043A\u0430. None \u2014 \u044F\u0437\u044B\u043A\u0430 \u0443 CLDR \u043D\u0435\u0442."""
    try:
        from babel import Locale

        return Locale(lang).territories
    except Exception:  # noqa: BLE001 - \u043D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u044B\u0439 \u044F\u0437\u044B\u043A \u043D\u0435 \u0434\u043E\u043B\u0436\u0435\u043D \u043B\u043E\u043C\u0430\u0442\u044C \u043F\u043E\u0438\u0441\u043A
        return None


def localized_country(code: str, fallback: str, lang: str | None) -> str:
    """\u0418\u043C\u044F \u0441\u0442\u0440\u0430\u043D\u044B \u043D\u0430 \u044F\u0437\u044B\u043A\u0435 \u043F\u0440\u0438\u043B\u043E\u0436\u0435\u043D\u0438\u044F; \u043D\u0435\u0437\u043D\u0430\u043D\u0438\u0435 \u2014 \u0447\u0435\u0441\u0442\u043D\u044B\u0439 \u0430\u043D\u0433\u043B\u0438\u0439\u0441\u043A\u0438\u0439."""
    short = (lang or "en").split("-")[0].split("_")[0].lower()
    upper = code.upper()
    override = _COUNTRY_OVERRIDES.get((upper, short))
    if override:
        return override
    if short == "en":
        return fallback
    names = _territories(short)
    if not names:
        return fallback
    return names.get(upper, fallback)
