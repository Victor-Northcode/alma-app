...
RECEIPT_PRODUCTS: dict[str, dict[str, str]] = {
    "en": {
        "door.natal": "Natal chart", "door.numerology": "Numerology",
        "door.birth-card": "Birth Card",
        "door.astrocartography": "Astrocartography",
        "door.synthesis": "Cross-synthesis",
    ...
    "es": {
        ...
        "door.birth-card": "Carta de nacimiento",
    ...
    "de": {
        ...
        "door.birth-card": "Geburtskarte",
        "door.astrocartography": "Astrokartografie",
        "door.synthesis": "Quersynthese",
    ...
    "it": {
        ...
        "door.birth-card": "Carta di nascita",
        "door.astrocartography": "Astrocartografia",
        "door.synthesis": "Sintesi incrociata",
    ...
    "pt-BR": {
        ...
        "door.birth-card": "Carta de nascimento",
        "door.astrocartography": "Astrocartografia",
        "door.synthesis": "Síntese cruzada",
    ...
    "ru": {
        ...
        "door.birth-card": "Карта рождения",
        "door.astrocartography": "Астрокартография",
        "door.synthesis": "Перекрёстный синтез",
