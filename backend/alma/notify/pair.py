...
# только в заголовке с именем — «{name} — ваш разбор готов», где имя партнёра
# и держит множественное «вы двое», как «eure» и «vocês» рядом. Безымянный
# заголовок якоря не имеет и читался вежливым «вы» — он на «ты», как
# испанский «Tu informe está listo» в том же слоте (ревью 27.08.2026).
# Правка 27.08.2026: «в вашем доме» читалось вежливым «вы» к одному
# человеку, чего русская Alma не делает нигде.
